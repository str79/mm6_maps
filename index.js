var langStr={
	...
	В конце двойной клик по названию \"группы\", метки скопируются в б/о. Переименовываем для нужной карты.<br> \
	<br>--------------Кратко\:----------------<br> \
	Есть карта, слева группы (элементов на карте), справа профили (разные карты), карту можно перемещать<br> \
	при клике на карту её можно двигать,<br> \
	при клике на элементе (кружке) на карте, его можно перемещать,<br> \
	...
	<br> \
	В левом меню при клике на названии группы, список этой группы раскрывается/закрывается и видны элемены в группе<br> \
	...
	двойной щелчок по любому месту на карте выводит его координаты в консоль и копирует их в буффер обмена (служебное).<br> \
	<br> \
